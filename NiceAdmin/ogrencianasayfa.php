...
try {
  ...
  $query = "SELECT COUNT(*) AS student_count FROM t_exam WHERE student_id = :student_id";
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
        <div>
            <div class="cardName">Sınav Sayısı</div>
    ...
    <div class="cardBox">
        <div class="card">
          <div>
            <div class="cardName">Genel Başarı Ortalaması:</div>
            <div class="numbers">65.1</div>
          </div>
        </div>
    </div> <br>
